...
{trailPositions.map((pos, index) => (
  ...
  <div className="container mx-auto">
    ...
    <div className="relative">
      ...
      <div className="absolute left-1/2 md:left-1/2 left-6 transform md:-translate-x-px -translate-x-1/2 h-full w-1 bg-gradient-to-b from-cyan-400/50 via-blue-400/50 to-purple-400/50 backdrop-blur-sm rounded-full"></div>
